...
from app.models import AttributionResult, ConversionEvent, Touchpoint
...
class AttributionEngine:
    ...
    def _filter_by_window(
        ...
        for tp in touchpoints:
            delta = conversion_time - self._naive(tp.event_time)
    ...
    def compare_models(
        ...
        conversion_time = self._naive(conversion_time or utc_now())
