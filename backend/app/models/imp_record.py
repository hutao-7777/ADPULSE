"""Unified impression record model supporting multiple data sources."""
...
class ImpRecord(Base):
    __tablename__ = "imp_records"
    ...
    __table_args__ = (
        Index("ix_imp_records_data_source", "data_source"),
        Index("ix_imp_records_timestamp", "timestamp"),
    )
