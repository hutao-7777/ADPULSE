"""Legacy A/B test simulation endpoints exposed under /api/v2."""
...
from app.models.models import ABTest, ABTestVariant, User
...
router = APIRouter(prefix="/api/v2/abtests-sim", tags=["abtest-simulation"])
