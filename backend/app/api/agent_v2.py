"""Production agent API endpoints (v2) using real LLM function calling."""
...
from app.agent.bidding_agent_v2 import BiddingAgentV2
...
async def run_agent(
    ...
    agent = BiddingAgentV2(db, current_user, config)
